...
namespace MonsterWorldLike.Core
{
    public class GameManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            MonsterManager.InstanceReady += OnSystemInstanceReady;
            ProgressionManager.InstanceReady += OnSystemInstanceReady;
            InventoryManager.InstanceReady += OnSystemInstanceReady;
            BuildingManager.InstanceReady += OnSystemInstanceReady;
            AreaManager.InstanceReady += OnSystemInstanceReady;
            DailyRewardManager.InstanceReady += OnSystemInstanceReady;
            QuestManager.InstanceReady += OnSystemInstanceReady;
        }
